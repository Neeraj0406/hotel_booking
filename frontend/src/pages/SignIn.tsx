...
const SignIn = () => {
    ...
    return (
        <form className="flex flex-col gap-5" onSubmit={onSubmit}>
            <h2 className="text-3-xl fond-bold">Sign In</h2>
            ...
            <button className="bg-blue-600 w-[190px] font-bold p-4 rounded-md text-white hover:bg-blue-500 mx-auto" type="submit"> Submit</button>
        </form>
    )
};
